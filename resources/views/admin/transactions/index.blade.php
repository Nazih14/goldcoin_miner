...
<head> 
    ...
    <!-- Favicon -->
    <link rel="apple-touch-icon" sizes="120x120" href="{{url('adminvolt/assets/img/favicon/apple-touch-icon.png')}}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{url('adminvolt/assets/img/favicon/favicon-32x32.png')}}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{url('adminvolt/assets/img/favicon/favicon-16x16.png')}}">
    <link rel="manifest" href="{{url('adminvolt/assets/img/favicon/site.webmanifest')}}">
    <link rel="mask-icon" href="{{url('adminvolt/assets/img/favicon/safari-pinned-tab.svg')}}" color="#ffffff">
    <meta name="msapplication-TileColor" content="#ffffff">
    <meta name="theme-color" content="#ffffff">
    
    <!-- Sweet Alert -->
    <link type="text/css" href="{{url('adminvolt/vendor/sweetalert2/dist/sweetalert2.min.css')}}" rel="stylesheet">
    
    <!-- Notyf -->
    <link type="text/css" href="{{url('adminvolt/vendor/notyf/notyf.min.css')}}" rel="stylesheet">
    
    <!-- Volt CSS -->
    <link type="text/css" href="{{url('adminvolt/css/volt.css')}}" rel="stylesheet">
...
<li class="nav-item">
    <a href="https://themesberg.com" target="_blank" class="nav-link d-flex align-items-center">
        <span class="sidebar-icon">
            <img src="{{url('adminvolt/assets/img/themesberg.svg')}}" height="20" width="28" alt="Themesberg Logo">
        </span>
    ...
    <nav class="navbar navbar-top navbar-expand navbar-dashboard navbar-dark ps-0 pe-2 pb-0">
                                ...
                                <div class="list-group list-group-flush">
                                    ...
                                    <a href="#" class="list-group-item list-group-item-action border-bottom">
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                <!-- Avatar -->
                                                <img alt="Image placeholder" src="{{url('adminvolt/assets/img/team/profile-picture-1.jpg')}}" class="avatar-md rounded">
                                            </div>
                                    ...
                                    <a href="#" class="list-group-item list-group-item-action border-bottom">
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                <!-- Avatar -->
                                                <img alt="Image placeholder" src="{{url('adminvolt/assets/img/team/profile-picture-2.jpg')}}" class="avatar-md rounded">
                                            </div>
                                            <div class="col ps-0 ms-2">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div>
                                    ...
                                    <a href="#" class="list-group-item list-group-item-action border-bottom">
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                <!-- Avatar -->
                                                <img alt="Image placeholder" src="{{url('adminvolt/assets/img/team/profile-picture-3.jpg')}}" class="avatar-md rounded">
                                            </div>
                                    ...
                                    <a href="#" class="list-group-item list-group-item-action border-bottom">
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                <!-- Avatar -->
                                                <img alt="Image placeholder" src="{{url('adminvolt/assets/img/team/profile-picture-4.jpg')}}" class="avatar-md rounded">
                                            </div>
                                            <div class="col ps-0 ms-2">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div>
                                    ...
                                    <a href="#" class="list-group-item list-group-item-action border-bottom">
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                <!-- Avatar -->
                                                <img alt="Image placeholder" src="{{url('adminvolt/assets/img/team/profile-picture-5.jpg')}}" class="avatar-md rounded">
                                            </div>
                                            <div class="col ps-0 ms-2">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div>
                        ...
                        <li class="nav-item dropdown ms-lg-3">
                            <a class="nav-link dropdown-toggle pt-1 px-0" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <div class="media d-flex align-items-center">
                                    <img class="avatar rounded-circle" alt="Image placeholder" src="{{url('adminvolt/assets/img/team/profile-picture-3.jpg')}}">
        ...
        <div class="theme-settings card bg-gray-800 pt-2 collapse" id="theme-settings">
            ...
            <div class="d-flex justify-content-center">
                ...
                target="_blank">
                <img src="{{url('adminvolt/assets/img/technologies/bootstrap-5-logo.svg')}}" class="image image-xs">
            </a>
            <a href="https://demo.themesberg.com/volt-react-dashboard/#/" target="_blank">
                <img src="{{url('adminvolt/assets/img/technologies/react-logo.svg')}}" class="image image-xs">
            </a>
        </div>
    </div>
</div>
...
<!-- Vendor JS -->
<script src="{{url('adminvolt/vendor/onscreen/dist/on-screen.umd.min.js')}}"></script>

<!-- Slider -->
<script src="{{url('adminvolt/vendor/nouislider/distribute/nouislider.min.js')}}"></script>

<!-- Smooth scroll -->
<script src="{{url('adminvolt/vendor/smooth-scroll/dist/smooth-scroll.polyfills.min.js')}}"></script>

<!-- Charts -->
<script src="{{url('adminvolt/vendor/chartist/dist/chartist.min.js')}}"></script>
<script src="{{url('adminvolt/vendor/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js')}}"></script>

<!-- Datepicker -->
<script src="{{url('adminvolt/vendor/vanillajs-datepicker/dist/js/datepicker.min.js')}}"></script>

<!-- Sweet Alerts 2 -->
<script src="{{url('adminvolt/vendor/sweetalert2/dist/sweetalert2.all.min.js')}}"></script>
...
<!-- Notyf -->
<script src="{{url('adminvolt/vendor/notyf/notyf.min.js')}}"></script>

<!-- Simplebar -->
<script src="{{url('adminvolt/vendor/simplebar/dist/simplebar.min.js')}}"></script>
