        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center d-flex align-items-center justify-content-center">
                    <div>
                        <img class="img-fluid w-75" src="{{url('adminvolt/assets/img/illustrations/404.svg')}}" alt="404 not found">
                        ...
                        <a href="{{ Auth::check() ? '/home' : '/'  }}" class="btn btn-gray-800 d-inline-flex align-items-center justify-content-center mb-4">
